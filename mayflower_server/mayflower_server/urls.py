...
urlpatterns = [
    ...
    path('api/v1/distance/frontCenter', include('mayflower_server.distance.frontCenter.urls')),
    path('api/v1/distance/frontLeft', include('mayflower_server.distance.frontLeft.urls')),
    path('api/v1/distance/frontRight', include('mayflower_server.distance.frontRight.urls')),
    path('api/v1/distance/leftAngle', include('mayflower_server.distance.leftAngle.urls')),
    path('api/v1/distance/rightAngle', include('mayflower_server.distance.rightAngle.urls')),
